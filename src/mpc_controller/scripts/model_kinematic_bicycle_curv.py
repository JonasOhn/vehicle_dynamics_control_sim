...
def export_vehicle_ode_model() -> AcadosModel:
    ...
    p = vertcat(m, l_f, l_r, C_d, C_r, kappa_ref, q_n, q_sd, q_mu, q_ax, q_dels, r_dax, r_ddels)
    ...
    # Stage Cost
    stage_cost = cost_sd + cost_n + cost_mu + cost_dels + cost_ax + cost_dax_m + cost_ddel_s
