...
with open(
    "src/sim_backend/tracks/straight_track_blue_cones.csv", "w", newline=""
) as csv_file:
...
with open(
    "src/sim_backend/tracks/straight_track_yellow_cones.csv", "w", newline=""
) as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=",")
...
with open(
    "src/sim_backend/tracks/straight_track_middle_path.csv", "w", newline=""
) as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=",")
